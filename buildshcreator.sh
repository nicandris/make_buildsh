...
sh -c "echo '	echo \"	-\"' >> ~/Desktop/build.sh"
sh -c "echo '	echo \"	12.EXIT\"' >> ~/Desktop/build.sh"
sh -c "echo '	echo ' >> ~/Desktop/build.sh"
...
sh -c "echo '	. build/envsetup.sh && brunch $device' >> ~/Desktop/build.sh"
sh -c "echo '	cd ~/android/system/out/target/product/$device/system/' >> ~/Desktop/build.sh"
...
sh -c "echo '	cp build.prop ~/android/system/out/target/product/$device/' >> ~/Desktop/build.sh"
sh -c "echo '	cd ~/android/system/out/target/product/$device/' >> ~/Desktop/build.sh"
sh -c "echo '	zip -qf update*.zip' >> ~/Desktop/build.sh"
sh -c "echo '	cp ~/android/system/out/target/product/$device/update*.zip ~/Desktop/Builds/update-cm-$device-\$(date +%d_%m-%H.%M).zip' >> ~/Desktop/build.sh"
sh -c "echo '	cp ~/android/system/out/target/product/$device/update*.md5sum ~/Desktop/Builds/update-cm-$device-\$(date +%d_%m-%H.%M).md5sum' >> ~/Desktop/build.sh"
sh -c "echo '	options_menu' >> ~/Desktop/build.sh"
sh -c "echo '	;;' >> ~/Desktop/build.sh"
sh -c "echo '' >> ~/Desktop/build.sh"
...
sh -c "echo '	;;' >> ~/Desktop/build.sh"
sh -c "echo '' >> ~/Desktop/build.sh"
sh -c "echo ' 7)   	cd ~/android/system/out/target/product/$device/system/' >> ~/Desktop/build.sh"
sh -c "echo '	Day=\`date +%d\`' >> ~/Desktop/build.sh"
sh -c "echo '	Date=\`date +%D\`' >> ~/Desktop/build.sh"
sh -c "echo '	Month=\`date +%m\`' >> ~/Desktop/build.sh"
sh -c "echo '	Year=\`date +%y\`' >> ~/Desktop/build.sh"
...
sh -c "echo '	options_menu' >> ~/Desktop/build.sh"
sh -c "echo '	;;' >> ~/Desktop/build.sh"
sh -c "echo ' 12) exit' >> ~/Desktop/build.sh"
sh -c "echo '' >> ~/Desktop/build.sh"
...
echo
echo "Time to check your build script on your Desktop."
echo